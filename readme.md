...
To minimiza memory access and maximize performance, a memory buffer is used during serialization. The capacity of the memory buffer is set during initialization.  
